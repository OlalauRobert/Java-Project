...
public class Jucator extends Entitate {
	...
	public Sunet fondSonor = new Sunet("/sunete/Heavy Dubstep.wav"); 
	public Sunet sunetPremiu = new Sunet("/sunete/joc.castigat.wav");
	public Sunet sunetPierdut = new Sunet("/sunete/joc.pierdut.wav");
	...
	public void deseneaza(Graphics2D g2) {	
		...
		if(panouJoc.premiu.verificaPremiu(this)) {
			g2.drawString("Timp:" + this.panouJoc.ceas + " sec.", 5, 40);
				...
				g2.drawString("Ai castigat!", 40 , 80); 
				this.viteza = 0;//  aici punem viteza jucatorului la 0 sa nu se mai poata misca
			}
	...
	public void update() {
		if( gestiuneTaste.susApasat == true || gestiuneTaste.josApasat == true ||
			...
			if ( panouJoc.premiu.verificaPremiu(this) == false && panouJoc.ceasFinal == 0 ) {
				...
				System.out.println("Ai ajuns la premiu ");
			}
